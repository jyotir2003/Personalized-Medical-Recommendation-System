    ...
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms":
            ...
            if predicted_disease is None:
                message = f"Sorry, none of the symptoms you entered are recognized. Please check your spelling or try different symptoms. Invalid symptoms: {', '.join(invalid_symptoms)}"
                return render_template('index.html', message=message)
            
            if invalid_symptoms:
                message = f"Some symptoms were not recognized and were ignored: {', '.join(invalid_symptoms)}"
            else:
                message = None
